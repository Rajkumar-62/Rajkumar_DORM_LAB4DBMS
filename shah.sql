...
FROM order
WHERE ORD_AMOUNT = 3000 AND > 3000

SELECT order.ORD_ID, customer.CUS_ID, customer.CUS_NAME
FROM order
INNER JOIN customer ON order.CUS_ID=customer.CUS_NAME
WHERE CUS_ID=2
